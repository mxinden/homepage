...
During the time of this project I (a) learned quickly that Android is not Linux and (b) that [Firefox still supports Android 5](https://support.mozilla.org/en-US/kb/will-firefox-work-my-mobile-device), ..., on x86 (not 64).
